...
const Chatbot = ({ email }) => {
    ...
    }, [messageHistory, model]); // Dependency on messageHistory and model
    ...
    return (
        <div className='bottom-section'>
            ...
            <InputForm inputValue={inputValue} handleInputChange={handleInputChange} handleSubmit={handleSubmit} />
